...
import com.medico.service.impl.UserSecurityService;
...
public class HomeController {
	...
	@RequestMapping("/medshelf")
	public String medshelf(Model model, Principal principal) {
		if(principal != null) {
