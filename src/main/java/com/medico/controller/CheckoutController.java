...
import com.medico.service.BillingAddressService;
import com.medico.service.CartItemService;
import com.medico.service.OrderService;
import com.medico.service.PaymentService;
import com.medico.service.ShippingAddressService;
...
import com.medico.utility.MailConstructor;
import com.medico.utility.INConstants;
...
public class CheckoutController {
	...
	public String checkout(@RequestParam("id") Long cartId,
		...
		for (CartItem cartItem : cartItemList) {
			if (cartItem.getMed().getInStockNumber() < cartItem.getQty()) {
	...
	public String checkoutPost(@ModelAttribute("shippingAddress") ShippingAddress shippingAddress,
		...
		Order order = orderService.createOrder(shoppingCart, shippingAddress, billingAddress, payment, shippingMethod, estimatedDeliveryDate, user);
